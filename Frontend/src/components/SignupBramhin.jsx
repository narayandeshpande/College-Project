        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <input
              type="text"
              id="name"
              className={`w-full px-4 py-2 border rounded-lg text-white bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.fullname ? 'border-red-500' : 'border-gray-300'}`}
          ...
          <div>
            ...
            <input
              type="email"
              id="email"
              className={`w-full px-4 py-2 border rounded-lg text-white bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.email ? 'border-red-500' : 'border-gray-300'}`}
          ...
          <div>
            ...
            <input
              type="password"
              id="password"
              className={`w-full px-4 py-2 border rounded-lg text-white bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.password ? 'border-red-500' : 'border-gray-300'}`}
          ...
          <div>
            ...
            <input
              type="text"
              id="no"
              className={`w-full px-4 py-2 border rounded-lg text-white bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.no ? 'border-red-500' : 'border-gray-300'}`}
          ...
          <div>
            ...
            <input
              type="text"
              id="otp"
              className={`w-full px-4 py-2 border rounded-lg text-white bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.otp ? 'border-red-500' : 'border-gray-300'}`}
